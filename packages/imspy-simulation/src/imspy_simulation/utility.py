...
from imspy_core.chemistry.constants import MASS_WATER
from imspy_core.chemistry.amino_acids import AMINO_ACID_MASSES
...
def get_acquisition_builder_resource_path(acquisition_mode: str = 'dia') -> Traversable:
    ...
    return resources.files('imspy_simulation.resources.configs').joinpath(acquisition_mode + 'pasef.toml')
...
def get_dilution_factors(path: str = None) -> Dict[str, float]:
    ...
    if path is not None:
        ...
        table = pd.read_csv(str(resources.files('imspy_simulation.resources.configs').joinpath('dilution_factors.csv')))
...
def get_ms_ms_window_layout_resource_path(acquisition_mode: str) -> Traversable:
    ...
    return resources.files('imspy_simulation.resources.configs').joinpath(acquisition_mode + '_ms_ms_windows.csv')
...
def get_native_dataset_path(ds_name: str = 'NATIVE.d') -> str:
    ...
    Returns:
        The path to the pretrained model
    """
    return str(resources.files('imspy_simulation.resources').joinpath(ds_name))
...
if __name__ == "__main__":
    ...
    from imspy_simulation.experiment import TimsTofSyntheticFrameBuilderDIA
