"""
Simple isotopic feature extraction from DIA clustering.

This module provides tools for building isotopic features from MS1 clusters.
"""
...
class AveragineLut:
    ...
    def from_py_ptr(cls, py_ptr: Any) -> "AveragineLut":
        ...
        self._AveragineLut__py_ptr = py_ptr
        return self
...
class SimpleFeatureParams:
    ...
    def from_py_ptr(cls, py_ptr: Any) -> "SimpleFeatureParams":
        self = cls.__new__(cls)
        self._SimpleFeatureParams__py_ptr = py_ptr
        return self
...
class SimpleFeature:
    ...
    def precursors(self) -> list["ClusterResult1D"]:
        ...
        return [
            ...
            for c in self.get_py_ptr().precursors
        ]
    ...
    def most_intense_precursor(self) -> "ClusterResult1D":
        ...
        return ClusterResult1D.from_py_ptr(
            self.get_py_ptr().most_intense_precursor
        )
