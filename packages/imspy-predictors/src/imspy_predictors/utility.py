...
from imspy_core.utility import tokenizer_from_json
...
def load_tokenizer_from_resources(tokenizer_name: str) -> tf.keras.preprocessing.text.Tokenizer:
    ...
    """
    return tokenizer_from_json(resources.files('imspy_predictors.pretrained').joinpath(f'{tokenizer_name}.json'))
