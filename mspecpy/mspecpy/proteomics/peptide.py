...
class PeptideProductIonSeriesCollection(RustWrapper):
    def __init__(self, series: List['PeptideProductIonSeries']):
        ...
        """
        self.__py_ptr = rmsc.PyPeptideProductIonSeriesCollection([s.get_py_ptr() for s in series])
    ...
    @classmethod
    def from_py_ptr(cls, collection: rmsc.PyPeptideProductIonSeriesCollection):
    ...
    def generate_isotopic_spectrum(
        ...
        """
        py_spec = self.__py_ptr.generate_isotopic_spectrum(mass_tolerance, abundance_threshold, max_result,
                                                           intensity_min)
...
class PeptideProductIonSeries(RustWrapper):
    def __init__(
        ...
        """
        self.__py_ptr = rmsc.PyPeptideProductIonSeries(
            charge=charge,
    ...
    @classmethod
    def from_py_ptr(cls, series: rmsc.PyPeptideProductIonSeries):
        instance = cls.__new__(cls)
...
class PeptideProductIon(RustWrapper):
    def __init__(self, kind: str, sequence: str, charge: int = 1, intensity: float = 1.0,
                 peptide_id: Union[None, int] = None):
        ...
        self.__py_ptr = rmsc.PyPeptideProductIon(
            kind=kind,
            sequence=sequence,
            charge=charge,
            intensity=intensity,
    ...
    @classmethod
    def from_py_ptr(cls, product_ion: rmsc.PyPeptideProductIon):
        instance = cls.__new__(cls)
...
class PeptideSequence(RustWrapper):
    def __init__(self, sequence: str, peptide_id: Union[None, int] = None):
        ...
        self.__py_ptr = rmsc.PyPeptideSequence(sequence, peptide_id=peptide_id)
    ...
    @classmethod
    def from_py_ptr(cls, obj: rmsc.PyPeptideSequence):
        instance = cls.__new__(cls)
...
class PeptideIon(RustWrapper):
    def __init__(self, sequence: str, charge: int, intensity: float, peptide_id: Union[None, int] = None):
        ...
        """
        self.__py_ptr = rmsc.PyPeptideIon(sequence, charge, intensity, peptide_id)
    ...
    def calculate_isotopic_spectrum(
        ...
        py_spec = self.__py_ptr.calculate_isotopic_spectrum(mass_tolerance, abundance_threshold, max_result,
                                                            intensity_min)
        return MzSpectrum.from_py_mz_spectrum(py_spec)
    ...
    @classmethod
    def from_py_ptr(cls, ion: rmsc.PyPeptideIon):
        instance = cls.__new__(cls)
