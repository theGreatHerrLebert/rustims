...
impl ScanDescriptor {
    ...
    /// on [`crate::projector::RenderedEvent`]'s isolation (which is m/z-only),
    /// so the driver supplies it. A [`crate::projector::RenderedEvent::MobilityFrame`]
    ...
    pub fn from_rendered_event(
        ev: &crate::projector::RenderedEvent,
        collision_energy: f64,
    ) -> Result<ScanDescriptor, String> {
        use crate::projector::RenderedEvent;
...
mod glue_tests {
    ...
    use crate::scheme::{DataMode, IsolationWindow as SchemeIso};
