...
impl TimsTofSyntheticsDataHandle {
    ...
    fn abundance_for_mode(
        a: f64,
        mode: crate::projector::ProjectionMode,
        num_decimals: u32,
    ) -> f32 {
        match mode {
            crate::projector::ProjectionMode::LegacyCompat => {
            ...
            crate::projector::ProjectionMode::Accurate => a as f32,
        }
    }
    ...
    fn project_peptide_scalars(
        ...
        mode: crate::projector::ProjectionMode,
        params: crate::projector::ProjectionParams,
    ) -> rusqlite::Result<Vec<PeptidesSim>> {
        ...
        let projected: Vec<Vec<(u32, f64)>> = match mode {
            ProjectionMode::LegacyCompat => crate::projector::project_time_legacy(
    ...
    fn project_ion_scalars(
        ...
        let projected: Vec<Vec<(i32, f64)>> = match mode {
            ProjectionMode::LegacyCompat => crate::projector::project_mobility_legacy_par(
            ...
            ProjectionMode::Accurate => {
                ...
                let acc = crate::projector::project_mobility_accurate_par(
    ...
    pub fn read_peptides_for_frame_range_with_source(
        ...
        if matches!(mode, crate::projector::ProjectionMode::Accurate) {
...
mod scalar_reader_tests {
    ...
    fn source_aware_reads_both_paths() {
        use crate::containers::MobilityEnv;
        use crate::projector::{DistributionSource, ProjectionMode, ProjectionParams};
