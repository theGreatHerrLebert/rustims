...
class TimsSlice:
    ...
    def filter(self, mz_min: float = 0.0, mz_max: float = 2000.0, scan_min: int = 0, scan_max: int = 1000,
        ...
        Args:
            ...
            frame_id_min (int, optional): Minimum frame ID. Defaults to 0.
            frame_id_max (int, optional): Maximum frame ID. Defaults to 100000.
            rt_min (float, optional): Minimum retention time. Defaults to 0.0.
            rt_max (float, optional): Maximum retention time. Defaults to 1e9.
