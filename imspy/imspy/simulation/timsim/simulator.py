...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--protein_abundance_bias", type=float, help="Protein abundance bias, how many copies each protein has at least (default: 0.0)",
                        default=0.0)
    ...
    if not args.from_existing:
        for fasta_name, fasta_path in fastas.items():
            ...
            proteins_tmp = simulate_proteins(
                ...
                intensity_bias=args.protein_abundance_bias,
            )
