...
/// Monoisotopic mass of the most abundant isotope of `symbol` (Da), or `None` if the symbol is
/// not a known element. Reads the single [`ELEMENTS`] table.
